...
export default function Sidenavbar () {
  return (
    <aside
      className='sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y'
      id='sidenav-main'
    >
          ...
          <div className='card-body text-start p-3 w-100'>
            ...
            <div className='docs-info'>
              ...
              <a
                ...
                target='_blank'
                className='btn btn-white btn-sm w-100 mb-0' rel='noreferrer'
              >
                Documentation
              </a>
            </div>
      ...
      <div className='ps__rail-y' style={{ top: 0, height: 2133, right: 0 }}>
        <div
          className='ps__thumb-y'
          tabIndex={0}
          style={{ top: 0, height: 2124 }}
        />
      </div>
    </aside>
